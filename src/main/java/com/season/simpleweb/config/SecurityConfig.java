package com.season.simpleweb.config;
...
import com.season.simpleweb.core.SAMLUserDetailsServiceImpl;
...
public class SecurityConfig implements InitializingBean, DisposableBean {
    ...
    @Bean
    public ExtendedMetadataDelegate ssoExtendedMetadataProvider(String url) throws MetadataProviderException {
        HTTPMetadataProvider provider = new HTTPMetadataProvider(this.backgroundTaskTimer, httpClient(), url);
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityBaseURL("https://");
        metadataGenerator.setEntityId("https:///sp/spring");
    ...
    public SAMLWebSSOHoKProcessingFilter samlWebSSOHoKProcessingFilter(
        ...
        samlWebSSOHoKProcessingFilter.setAuthenticationManager(authenticationConfiguration.getAuthenticationManager());
    ...
    public SAMLProcessingFilter samlWebSSOProcessingFilter(
        ...
        samlWebSSOProcessingFilter.setAuthenticationManager(authenticationConfiguration.getAuthenticationManager());
     ...
     */
    @Bean
    public FilterChainProxy samlFilter(AuthenticationConfiguration authenticationConfiguration) throws Exception {
        ...
        chains.add(new DefaultSecurityFilterChain(new AntPathRequestMatcher("/saml/SSO/**"),
                samlWebSSOProcessingFilter(authenticationConfiguration)));
        chains.add(new DefaultSecurityFilterChain(new AntPathRequestMatcher("/saml/SSOHoK/**"),
                samlWebSSOHoKProcessingFilter(authenticationConfiguration)));
